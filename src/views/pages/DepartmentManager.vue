    ...
    <div>
        <el-card style='min-height:600px;'>
            <el-form inline>
                <el-form-item label="部门编号:">
                    <el-input size='mini' prefix-icon='el-icon-data-analysis' type="text" v-model="queryParams.deptCode"
                        autocomplete="off" placeholder="部门编号"></el-input>
                </el-form-item>
                <el-form-item label="部门名称:">
                    <el-input size='mini' prefix-icon='el-icon-data-analysis' type="text" v-model="queryParams.deptName"
                        autocomplete="off" placeholder="部门编号"></el-input>
                </el-form-item>
                <el-form-item label="部门线路:">
                    <el-select size='mini' v-model="queryParams.line" placeholder="">
                        <el-option v-for="(item,key) in  selectOption" :key="key" :label="item.label"
            ...
            <el-row type="flex" justify="center">
                <el-pagination background :total="paginationConfig.total" :current-page="paginationConfig.currentPage"
                    :page-size="paginationConfig.pageSize" @current-change="currentChange"
        ...
        <el-dialog title="添加部门" :visible.sync="addDepartFormVisible" width="30%">
            <el-form label-position='left'>
                <el-form-item label="部门编号:">
                    <el-input style="width:55%" prefix-icon='el-icon-data-analysis' type="text"
                        v-model="addDepartForm.deptCode" autocomplete="off" placeholder="部门编号"></el-input>
                </el-form-item>
                <el-form-item label="部门名称:">
                    <el-input style="width:55%" prefix-icon='el-icon-data-analysis' type="text"
                        v-model="addDepartForm.deptName" autocomplete="off" placeholder="部门名称"></el-input>
                </el-form-item>
                <el-form-item label="部门线路:">
        ...
        <el-dialog title="更新部门" :visible.sync="updateDepartFormVisible" width="30%">
            <el-form label-position='left'>
                <el-form-item label="部门编号:">
                    <el-input disabled style="width:55%" prefix-icon='el-icon-data-analysis' type="text"
                        v-model="updateDepartForm.deptCode" autocomplete="off" placeholder="部门编号"></el-input>
                </el-form-item>
                <el-form-item label="部门名称:">
                    <el-input style="width:55%" prefix-icon='el-icon-data-analysis' type="text"
                        v-model="updateDepartForm.deptName" autocomplete="off" placeholder="部门名称"></el-input>
                </el-form-item>
                <el-form-item label="部门线路:">
